...
void example04() {
    ...
    auto sw2y = ext::make_shared<SwapRateHelper>( 0.002230,  2 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw3y = ext::make_shared<SwapRateHelper>( 0.002760,  3 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw4y = ext::make_shared<SwapRateHelper>( 0.003530,  4 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw5y = ext::make_shared<SwapRateHelper>( 0.004520,  5 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw6y = ext::make_shared<SwapRateHelper>( 0.005720,  6 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw7y = ext::make_shared<SwapRateHelper>( 0.007050,  7 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw8y = ext::make_shared<SwapRateHelper>( 0.008420,  8 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw9y = ext::make_shared<SwapRateHelper>( 0.009720,  9 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw10y = ext::make_shared<SwapRateHelper>(0.010900, 10 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw12y = ext::make_shared<SwapRateHelper>(0.012870, 12 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw15y = ext::make_shared<SwapRateHelper>(0.014970, 15 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw20y = ext::make_shared<SwapRateHelper>(0.017000, 20 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);
    auto sw30y = ext::make_shared<SwapRateHelper>(0.018210, 30 * Years, TARGET(), Annual, ModifiedFollowing, dayCounter, euribor6m);

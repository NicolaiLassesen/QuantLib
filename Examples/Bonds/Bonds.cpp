...
int bootstrapSwap() {
    ...
    auto dayCounter = Thirty360(Thirty360::European);

    auto sw2y = ext::make_shared<SwapRateHelper>( 0.0024730,  2 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw3y = ext::make_shared<SwapRateHelper>( 0.0026516,  3 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw4y = ext::make_shared<SwapRateHelper>( 0.0030825,  4 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw5y = ext::make_shared<SwapRateHelper>( 0.0037200,  5 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw6y = ext::make_shared<SwapRateHelper>( 0.0004520,  6 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw7y = ext::make_shared<SwapRateHelper>( 0.0053570,  7 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw8y = ext::make_shared<SwapRateHelper>( 0.0061475,  8 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw9y = ext::make_shared<SwapRateHelper>( 0.0068740,  9 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw10y = ext::make_shared<SwapRateHelper>(0.0075300, 10 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw11y = ext::make_shared<SwapRateHelper>(0.0081030, 11 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw12y = ext::make_shared<SwapRateHelper>(0.0086110, 12 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw15y = ext::make_shared<SwapRateHelper>(0.0097065, 15 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw20y = ext::make_shared<SwapRateHelper>(0.0107923, 20 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
    auto sw30y = ext::make_shared<SwapRateHelper>(0.0114450, 30 * Years, rateHelperCalendar, Semiannual, ModifiedFollowing, dayCounter, usdLibor3M);
